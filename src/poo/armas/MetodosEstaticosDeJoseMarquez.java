...
public class MetodosEstaticosDeJoseMarquez {
    ...
    /*
     * Un método imprimirInventario que reciba un InventarioNombreApellido1, no devuelva nada e imprima las poo.armas en
    ...
    public static void imprimirInventario(InventarioJoseMarquez miArmeria) {
    }
}