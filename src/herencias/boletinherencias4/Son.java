...
public class Son {
    ...
    public Son(String birthday, char sex, String name, String lastName) {
    ...
    public Son(Father father1, Father father2) {
        this.father1 = father1;
        this.father2 = father2;
    }

    public void flojear(){
        System.out.println("Estoy flojeando");
    }

    @Override
    void darSermon() throws OperationNotSupportedException {
        throw new OperationNotSupportedException("Es muy joven.");
    }
}